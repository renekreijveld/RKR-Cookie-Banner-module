...
$showbanner = JFactory::getApplication()->input->cookie->get('rkr_accept_cookies', 'empty');
if ($showbanner == 'empty') require JModuleHelper::getLayoutPath('mod_rkr_cookiebanner', 'default');
